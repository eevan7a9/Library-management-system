...
class AccountsController extends Controller
{
    ...
    public function index()
    {
        if (Auth::check()) {
            $users = Auth()->user();
            $users_created = User::find($users->id);
            /** get the created author, categories, etc... **/

            $issued = Borrower::all()->where('librarian_id', '=', $users->id);
            /** get issued books from borrowers table */
    ...
    {
        return redirect('/accounts')->with('error',  "This action is restricted for this Demo Project");
        ...
        //     /** Check if user wants a new password */
        //     $users = User::find($id);
