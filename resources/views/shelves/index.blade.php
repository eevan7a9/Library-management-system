        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <h1 class="custom-font-cursive">Shelves
                        @can('isLibrarian', Auth::user())
                            <small>you added</small>
                        @endcan
                        :<a href="shelves/create"><button class="btn btn-success"><i class="fas fa-plus-square mr-1"></i>New</button></a></h1>
                </div>
                    ...
                    <tbody class="custom-tbody">
                        ...
                        @foreach ($shelves as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="shelves/{{ $item->id }}/edit" class="btn btn-primary"><i class="fas fa-edit"></i>Edit</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
